...
public class NewSchedulePageActivity extends AppCompatActivity {
    ...
    private void Complete() {
        if(!othersFunction.isEdittextNotEmpty(Name_et,"名稱",NewSchedulePageActivity.this))return;
        if(!othersFunction.isDateType(Date_et,"日期",NewSchedulePageActivity.this))return;
        if(!othersFunction.isTimeType(Time_et,"時間",NewSchedulePageActivity.this))return;
