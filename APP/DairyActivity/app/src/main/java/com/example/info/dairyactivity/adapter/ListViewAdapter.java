...
import com.example.info.dairyactivity.DairyDbTable;
import com.example.info.dairyactivity.DairyPageActivity;
import com.example.info.dairyactivity.MainActivity;
...
public class ListViewAdapter extends BaseSwipeAdapter {
    ...
    public ListViewAdapter(Context mContext, Cursor cursor, DairyDbTable DairyDb,ListView listView, ListView.OnItemClickListener List_listener) {
    ...
    public View generateView(final int position, ViewGroup parent) {
        ...
        v.findViewById(R.id.delete).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DairyDb.deleteDairyData(DairyId);
        ...
        v.findViewById(R.id.edit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(mContext, DairyPageActivity.class);
